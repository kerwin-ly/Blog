...
1.添加onMomentumScrollStart属性给FlatList（onMomentumScrollStart属性可以在ScrollView中查到,表示滚动动画开始的一个回调函数）
```
<FlatList
  ...
  ...
  onMomentumScrollStart={() => { this.onEndReachedCalledDuringMomentum = false; }}
/>
